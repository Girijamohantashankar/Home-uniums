                    ...
                    <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                        <div>
                            ...
                            <input
                                ...
                                className="w-full p-3 mt-1 border rounded-md focus:ring-2 focus:ring-blue-400 bg-gray-100 dark:bg-gray-800 dark:text-white transition-transform duration-300 hover:scale-105"
                            />
                        ...
                        <button
                            type="submit"
                            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg flex items-center justify-center gap-2 transition-transform duration-300 hover:scale-105"
                        >
